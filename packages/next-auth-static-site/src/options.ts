...
// Set `NEXT_PUBLIC_AUTH_LOGIN_PAGE_SLUG` from env, otherwise use default value
const NEXT_PUBLIC_AUTH_LOGIN_PAGE_SLUG = process.env
  .NEXT_PUBLIC_AUTH_LOGIN_PAGE_SLUG
  ? process.env.NEXT_PUBLIC_AUTH_LOGIN_PAGE_SLUG
  : "/login";
...
// Set `NEXT_PUBLIC_AUTH_REFRESH_THRESHOLD` from env, otherwise use default value
// Value is in seconds
const NEXT_PUBLIC_AUTH_REFRESH_THRESHOLD = process.env
  .NEXT_PUBLIC_AUTH_REFRESH_THRESHOLD
  ? Number(process.env.NEXT_PUBLIC_AUTH_REFRESH_THRESHOLD)
  : 10;
